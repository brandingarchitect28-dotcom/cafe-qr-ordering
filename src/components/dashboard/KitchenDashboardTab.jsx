...
if (typeof document !== 'undefined' && !document.getElementById('kdt-cafe-css')) {
  ...
  el.textContent = `
    ...
    .kdt-card:hover { border-color: rgba(255,140,0,0.22); }
    .kdt-order-card {
      background: #141008;
      border: 1.5px solid rgba(255,255,255,0.07);
      border-radius: 14px;
    ...
    .kdt-order-card:hover { border-color: rgba(255,140,0,0.22); }
    ...
    <div className="kdt space-y-5">
      ...
      <div className="kdt-card p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <a
          ...
          style={{ background: 'linear-gradient(135deg,#FF7A20,#E55A00)', boxShadow: '0 4px 16px rgba(255,120,0,0.3)' }}
        >
          <ExternalLink className="w-4 h-4" />
          🖥️ Open Kitchen Screen
        </a>
      </div>
      ...
      <div className="kdt-card px-4 py-3 flex items-center gap-3">
        ...
        <button
          ...
          style={{ background: 'rgba(255,140,0,0.1)', color: '#FF7A20', border: '1.5px solid rgba(255,140,0,0.2)' }}
        >
          Copy
        </button>
      </div>
                ...
                <motion.div key={order.id} layout initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -6 }} className="kdt-order-card">
                  ...
                  <div className="flex items-start gap-4 px-4 py-3 flex-wrap">
                    <div className="flex items-center gap-2 min-w-[90px]">
                      ...
                      <span className="font-black text-sm kdt-title" style={{ color: '#FF7A20' }}>
