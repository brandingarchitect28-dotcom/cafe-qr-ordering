/**
 * StaffList.jsx
 * Staff CRUD + QR code display per staff member.
 * QR encodes: cafeId|staffId — scanned by AttendanceScanner.
 */
...
import {
  ...
  Phone, CreditCard, Clock, ChevronDown, AlertCircle,
  RefreshCw, User,
} from 'lucide-react';
      ...
      {loading ? (
        ...
        <div className="bg-[#0F0F0F] border border-white/5 rounded-2xl p-12 text-center">
          ...
          <button onClick={() => setShowForm(true)}
            className="mt-4 text-[#D4AF37] text-sm underline underline-offset-2">Add your first team member</button>
        </div>
      ) : (
