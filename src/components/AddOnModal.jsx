...
const AddOnModal = ({
  ...
  // normalizeAddons — guarantees every addon has an id before any state operations.
  // Fixes: "clicking one addon updates ALL" (undefined key collision in addonQtys)
  // and "manual addons disappearing" (React key=undefined de-duplication).
  // Add-only — zero changes to addon rendering or confirmation logic.
