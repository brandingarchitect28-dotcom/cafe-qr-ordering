...
// ── SCREEN 1: Customer Chef Loading ──────────────────────────────────────────
const ChefLoadingScreen = () => {
  ...
  return (
    <div style={{
      ...
      overflow:'hidden', position:'relative', fontFamily:"'Nunito', system-ui, sans-serif",
    }}>
      <div style={{
        position:'absolute', top:'20%', left:'50%', transform:'translateX(-50%)',
        width:340, height:340, borderRadius:'50%', background:'#D4AF37', filter:'blur(90px)',
        pointerEvents:'none', animation:'app-pulse-glow 4s ease-in-out infinite',
      }}/>
      <div style={{
        position:'absolute', bottom:'15%', right:'8%',
        width:200, height:200, borderRadius:'50%', background:'#ff6b35', filter:'blur(70px)',
        pointerEvents:'none', animation:'app-pulse-glow2 6s ease-in-out infinite 2s',
      }}/>
      {floatingFoods.map((food, i) => (
        <div key={i} style={{
          position:'absolute', left:`${8+(i*9)%82}%`, bottom:`${8+(i*13)%28}%`,
          fontSize:18+(i%3)*7, pointerEvents:'none', userSelect:'none',
      ...
      <div style={{
        ...
        border:'1px solid rgba(212,175,55,0.28)', borderRadius:32,
        padding:'44px 40px 38px', maxWidth:310, width:'86vw', textAlign:'center',
        ...
        <div style={{ position:'relative', width:112, height:112, margin:'0 auto 26px' }}>
          <div style={{
            ...
            <span style={{ fontSize:28, display:'block', lineHeight:1, animation:'app-plate-spin 9s linear infinite' }}>🍽️</span>
          </div>
          <span style={{
            position:'absolute', top:0, left:'50%', fontSize:40, lineHeight:1, display:'block',
        ...
        <div style={{ height:3, background:'rgba(255,255,255,0.06)', borderRadius:99, overflow:'hidden' }}>
          <div style={{
            ...
            borderRadius:99, animation:'app-shimmer 1.4s ease-in-out infinite',
          }}/>
        </div>
      </div>
      <p style={{
        marginTop:30, color:'rgba(255,255,255,0.16)', fontSize:11, fontWeight:600,
        letterSpacing:'0.15em', textTransform:'uppercase',
        zIndex:10, position:'relative', userSelect:'none',
        animation:'app-whisper-in 0.6s ease both 0.7s', opacity:0,
      }}>Crafting your experience</p>
    </div>
  );
};

// ── SCREEN 2: Staff/Admin Workspace Loading ───────────────────────────────────
const WorkspaceLoadingScreen = () => {
  ...
  return (
    <div style={{
      ...
      {particles.map((p, i) => (
        <div key={i} style={{
          position:'absolute', left:`${6+(i*12)%86}%`, bottom:`${10+(i*11)%35}%`,
          fontSize:10+(i%4)*4, color:`rgba(212,175,55,${0.06+(i%3)*0.04})`,
      ...
      <div style={{
        ...
        border:'1px solid rgba(212,175,55,0.22)', borderRadius:32,
        padding:'48px 44px 42px', maxWidth:320, width:'86vw', textAlign:'center',
        ...
        <div style={{ position:'relative', width:100, height:100, margin:'0 auto 28px' }}>
          <div style={{
            ...
            border:'1.5px solid rgba(212,175,55,0.2)', borderTopColor:'rgba(212,175,55,0.7)',
          ...
          <div style={{
            ...
            borderBottomColor:'rgba(212,175,55,0.5)', borderRightColor:'rgba(212,175,55,0.5)',
            animation:'app-ring-spin-rev 2.2s linear infinite',
          }}/>
          <div style={{
            position:'absolute', top:'50%', left:'50%',
            width:52, height:52, borderRadius:'50%',
            border:'1px solid rgba(212,175,55,0.08)', borderTopColor:'rgba(212,175,55,0.35)',
          ...
          <div style={{
            ...
            <span style={{ fontSize:20, color:'#D4AF37', fontWeight:900, lineHeight:1, animation:'app-symbol-glow 2.5s ease-in-out infinite' }}>◈</span>
          </div>
        </div>
        <h2 style={{ margin:'0 0 6px', color:'#ffffff', fontWeight:900, fontSize:21, fontFamily:"'Playfair Display', serif", letterSpacing:'-0.01em' }}>
          SmartCafé OS
        </h2>
        <p style={{ margin:'0 0 8px', color:'#D4AF37', fontWeight:700, fontSize:11, opacity:0.75, letterSpacing:'0.18em', textTransform:'uppercase' }}>
          by Branding Architect
        </p>
        <p style={{ margin:'0 0 28px', color:'rgba(255,255,255,0.38)', fontWeight:600, fontSize:12 }}>
        ...
        <div style={{ height:2, background:'rgba(255,255,255,0.05)', borderRadius:99, overflow:'hidden' }}>
          <div style={{
            ...
            borderRadius:99, animation:'app-shimmer 1.6s ease-in-out infinite',
          }}/>
        </div>
        <div style={{
          marginTop:22, paddingTop:18, borderTop:'1px solid rgba(212,175,55,0.08)',
          display:'flex', alignItems:'center', justifyContent:'center', gap:6,
        }}>
          <div style={{ width:4, height:4, borderRadius:'50%', background:'rgba(212,175,55,0.35)' }}/>
          <span style={{ fontSize:10, fontWeight:700, color:'rgba(212,175,55,0.35)', letterSpacing:'0.2em', textTransform:'uppercase' }}>Secure Session</span>
          <div style={{ width:4, height:4, borderRadius:'50%', background:'rgba(212,175,55,0.35)' }}/>
        </div>
      </div>
      <p style={{
        marginTop:28, color:'rgba(255,255,255,0.12)', fontSize:10, fontWeight:600,
        letterSpacing:'0.18em', textTransform:'uppercase',
        zIndex:10, position:'relative', userSelect:'none',
        animation:'app-whisper-in 0.6s ease both 0.8s', opacity:0,
      }}>Powered by Branding Architect</p>
    </div>
  );
};
      ...
      <Router>
        <div className="App">
          <Routes>
            ...
            <Route path="/dashboard" element={<ProtectedRoute allowedRoles={['cafe']}><Dashboard /></ProtectedRoute>} />
          ...
          <Toaster
            position="top-right"
            toastOptions={{
              style: { background:'#0F0F0F', color:'#E5E5E5', border:'1px solid rgba(255,255,255,0.1)' },
            }}
          />
        </div>
      </Router>
